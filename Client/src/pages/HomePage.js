...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <p className="text-black text-4xl font-bold mb-1 text-center mt-2">
        My List
      </p>
      <div className="w-full flex relative items-center">
        ...
        <div
          id="scroll"
          className="h-full w-full overflow-hidden border shadow-lg whitespace-nowrap scroll-smooth"
        >
