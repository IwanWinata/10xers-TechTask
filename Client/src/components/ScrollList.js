    ...
    <>
      ...
      <div className="w-5/6 flex relative items-center m-auto shadow-lg border mb-10">
        ...
        <div
          ...
          className="h-full w-full whitespace-nowrap overflow-x-hidden scroll-smooth"
        >
          {movies.map((el) => (
            <div className="w-[220px] h-[300px] inline-block p-2 group perspective">
                ...
                <div className="absolute my-rotate-y-180 w-full h-full backface-hidden bg-gray-200">
                    <div className="text-center flex flex-col items-center justify-center text-orange-500 h-full">
                        ...
                        <button className="mt-2 text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Add To My List</button>
